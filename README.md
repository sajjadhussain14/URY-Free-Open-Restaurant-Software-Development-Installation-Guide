...
<head>
  <meta charset="UTF-8">
  <title>URY (Free & Open Restaurant Software) – Development Installation Guide</title>
  <style>
    body {
...
<body>
  <h1>URY – Development Installation Guide (Ubuntu 24.04 WSL2)</h1>
  ...
  <h2>0 — Prelim Notes & WSL2 Tips</h2>
  <ul>
    ...
    <li><strong>WSL2 systemd</strong>: If services like MariaDB/Redis don’t start, enable systemd in WSL2 or start services manually (<code>sudo service mariadb start</code>).</li>
  </ul>
  ...
  <h2>1 — Update System & Install Base Packages</h2>
...
sudo npm install -g yarn
  ...
  <h2>3 — Install wkhtmltopdf (Patched Qt Build)</h2>
...
bench get-app ury https://github.com/ury-erp/ury.git
  ...
  <h2>8 — Create Site & Install Apps</h2>
...
bench --site ury.local migrate
  ...
  <h2>🔍 Common Asset Issues After Installation</h2>
...
sudo chown -R $USER:$USER ~/frappe-bench/sites
  ...
  <div class="tip">
    ✅ Always run <code>bench build</code> + <code>bench clear-cache</code> after updates or new app installs.
  </div>

  <hr>

  <h2>✅ Patterns of Successful Installs</h2>
  <ul>
  ...
  <h2>📢 Community Insights (2024–2025)</h2>
  <ul>
    <li><strong>ERPNext/Frappe users:</strong> “Setup is hard first time, but stable once running.”</li>
    <li><strong>Developers:</strong> “Use events, keep controllers clean, plan migrations.”</li>
  ...
  <ul>
    <li><code>bench start</code> → Start dev server.</li>
    <li><code>bench --site ury.local console</code> → Python shell for site.</li>
    <li><code>bench clear-cache</code> → Clear cache.</li>
